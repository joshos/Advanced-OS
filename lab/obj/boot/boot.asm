...
seta20.2:
  ...
  lgdt    gdtdesc			#gdt address => 0x7c64
    7c1e:	0f 01 16             	lgdtl  (%esi)
    7c21:	64                   	fs
    7c22:	7c 0f                	jl     7c33 <protcseg+0x1>
  movl    %cr0, %eax
    7c24:	20 c0                	and    %al,%al
  orl     $CR0_PE_ON, %eax	#Turns the protection bit in cr0 on
...
bootmain(void)
{
	...
	readseg((uint32_t) ELFHDR, SECTSIZE*8, 0);	//offset is zero since it is copying the kernel itself
    7d0f:	6a 00                	push   $0x0
    ...
    7d49:	73 16                	jae    7d61 <bootmain+0x57>
		...
		readseg(ph->p_pa, ph->p_memsz, ph->p_offset);		//kernel start address
