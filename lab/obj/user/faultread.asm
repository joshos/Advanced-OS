...
umain(int argc, char **argv)
{
  ...
  800049:	e8 17 01 00 00       	call   800165 <cprintf>
}
  80004e:	c9                   	leave  
  80004f:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  80005c:	8b 7d 0c             	mov    0xc(%ebp),%edi
  ...
  80005f:	e8 01 0b 00 00       	call   800b65 <sys_getenvid>
	int index = envid & (1023);
  800064:	25 ff 03 00 00       	and    $0x3ff,%eax
  800069:	89 c6                	mov    %eax,%esi
	cprintf("Value of x:%x\n",index);
  80006b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80006f:	c7 04 24 be 10 80 00 	movl   $0x8010be,(%esp)
  800076:	e8 ea 00 00 00       	call   800165 <cprintf>
	thisenv = &envs[index];
  80007b:	6b f6 7c             	imul   $0x7c,%esi,%esi
  80007e:	81 c6 00 00 c0 ee    	add    $0xeec00000,%esi
  800084:	89 35 04 20 80 00    	mov    %esi,0x802004
	// save the name of the program so that panic() can use it
	if (argc > 0)
  80008a:	85 db                	test   %ebx,%ebx
  80008c:	7e 07                	jle    800095 <libmain+0x45>
		binaryname = argv[0];
  80008e:	8b 07                	mov    (%edi),%eax
  800090:	a3 00 20 80 00       	mov    %eax,0x802000

	// call user main routine
	umain(argc, argv);
  800095:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800099:	89 1c 24             	mov    %ebx,(%esp)
  80009c:	e8 92 ff ff ff       	call   800033 <umain>

	// exit gracefully
	exit();
  8000a1:	e8 08 00 00 00       	call   8000ae <exit>
}
  8000a6:	83 c4 1c             	add    $0x1c,%esp
  8000a9:	5b                   	pop    %ebx
  8000aa:	5e                   	pop    %esi
  8000ab:	5f                   	pop    %edi
  8000ac:	5d                   	pop    %ebp
...
exit(void)
{
  ...
  8000bb:	e8 53 0a 00 00       	call   800b13 <sys_env_destroy>
}
  8000c0:	c9                   	leave  
  8000c1:	c3                   	ret    
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800139:	c7 04 24 c2 00 80 00 	movl   $0x8000c2,(%esp)
  800140:	e8 a9 01 00 00       	call   8002ee <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800158:	e8 79 09 00 00       	call   800ad6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 d7 10 80 00 	movsbl 0x8010d7(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80041f:	c7 44 24 08 ef 10 80 	movl   $0x8010ef,0x8(%esp)
  800426:	00 
  ...
  80043f:	c7 44 24 08 f8 10 80 	movl   $0x8010f8,0x8(%esp)
  800446:	00 
  ...
  800471:	b8 e8 10 80 00       	mov    $0x8010e8,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800deb:	e8 75 f3 ff ff       	call   800165 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800df0:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800df4:	8b 45 10             	mov    0x10(%ebp),%eax
  800df7:	89 04 24             	mov    %eax,(%esp)
  800dfa:	e8 05 f3 ff ff       	call   800104 <vcprintf>
	cprintf("\n");
  800dff:	c7 04 24 bc 10 80 00 	movl   $0x8010bc,(%esp)
  800e06:	e8 5a f3 ff ff       	call   800165 <cprintf>
