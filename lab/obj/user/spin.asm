...
umain(int argc, char **argv)
{
  ...
  80004e:	e8 6b 01 00 00       	call   8001be <cprintf>
	if ((env = fork()) == 0) {
  800053:	e8 c0 0d 00 00       	call   800e18 <fork>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024f:	e8 6c 0c 00 00       	call   800ec0 <__udivdi3>
  ...
  8002b8:	0f be 80 00 12 80 00 	movsbl 0x801200(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003d3:	ff 24 8d c0 12 80 00 	jmp    *0x8012c0(,%ecx,4)
  ...
  80049f:	c7 44 24 08 21 12 80 	movl   $0x801221,0x8(%esp)
  8004a6:	00 
  ...
  8004d1:	b8 11 12 80 00       	mov    $0x801211,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ba0:	00 
  800ba1:	c7 44 24 08 48 14 80 	movl   $0x801448,0x8(%esp)
  800ba8:	00 
  800ba9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bb0:	00 
  800bb1:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  800bb8:	e8 9f 02 00 00       	call   800e5c <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c32:	00 
  800c33:	c7 44 24 08 48 14 80 	movl   $0x801448,0x8(%esp)
  800c3a:	00 
  800c3b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c42:	00 
  800c43:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  800c4a:	e8 0d 02 00 00       	call   800e5c <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c85:	00 
  800c86:	c7 44 24 08 48 14 80 	movl   $0x801448,0x8(%esp)
  800c8d:	00 
  800c8e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c95:	00 
  800c96:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  800c9d:	e8 ba 01 00 00       	call   800e5c <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cd8:	00 
  800cd9:	c7 44 24 08 48 14 80 	movl   $0x801448,0x8(%esp)
  800ce0:	00 
  800ce1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce8:	00 
  800ce9:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  800cf0:	e8 67 01 00 00       	call   800e5c <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d2b:	00 
  800d2c:	c7 44 24 08 48 14 80 	movl   $0x801448,0x8(%esp)
  800d33:	00 
  800d34:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d3b:	00 
  800d3c:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  800d43:	e8 14 01 00 00       	call   800e5c <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d7e:	00 
  800d7f:	c7 44 24 08 48 14 80 	movl   $0x801448,0x8(%esp)
  800d86:	00 
  800d87:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d8e:	00 
  800d8f:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  800d96:	e8 c1 00 00 00       	call   800e5c <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800df3:	00 
  800df4:	c7 44 24 08 48 14 80 	movl   $0x801448,0x8(%esp)
  800dfb:	00 
  800dfc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e03:	00 
  800e04:	c7 04 24 65 14 80 00 	movl   $0x801465,(%esp)
  800e0b:	e8 4c 00 00 00       	call   800e5c <_panic>
...
fork(void)
{
  ...
  800e1e:	c7 44 24 08 7f 14 80 	movl   $0x80147f,0x8(%esp)
  800e25:	00 
  800e26:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  800e2d:	00 
  800e2e:	c7 04 24 73 14 80 00 	movl   $0x801473,(%esp)
  800e35:	e8 22 00 00 00       	call   800e5c <_panic>
...
sfork(void)
{
  ...
  800e40:	c7 44 24 08 7e 14 80 	movl   $0x80147e,0x8(%esp)
  800e47:	00 
  800e48:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800e4f:	00 
  800e50:	c7 04 24 73 14 80 00 	movl   $0x801473,(%esp)
  800e57:	e8 00 00 00 00       	call   800e5c <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e61:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800e64:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800e67:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800e6d:	e8 53 fd ff ff       	call   800bc5 <sys_getenvid>
  ...
  800e80:	89 74 24 08          	mov    %esi,0x8(%esp)
  800e84:	89 44 24 04          	mov    %eax,0x4(%esp)
  800e88:	c7 04 24 94 14 80 00 	movl   $0x801494,(%esp)
  800e8f:	e8 2a f3 ff ff       	call   8001be <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e94:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800e98:	8b 45 10             	mov    0x10(%ebp),%eax
  800e9b:	89 04 24             	mov    %eax,(%esp)
  800e9e:	e8 ba f2 ff ff       	call   80015d <vcprintf>
	cprintf("\n");
  800ea3:	c7 04 24 f4 11 80 00 	movl   $0x8011f4,(%esp)
  800eaa:	e8 0f f3 ff ff       	call   8001be <cprintf>
