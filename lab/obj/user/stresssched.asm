...
umain(int argc, char **argv)
{
  ...
  80004f:	bb 00 00 00 00       	mov    $0x0,%ebx
		if (fork() == 0)
  800054:	e8 5f 0e 00 00       	call   800eb8 <fork>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800199:	c7 04 24 04 12 80 00 	movl   $0x801204,(%esp)
  ...
  8001af:	e8 51 00 00 00       	call   800205 <vcprintf>
	cprintf("\n");
  8001b4:	c7 04 24 f7 11 80 00 	movl   $0x8011f7,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ef:	e8 0c 0c 00 00       	call   800f00 <__udivdi3>
  ...
  80034f:	e8 dc 0c 00 00       	call   801030 <__umoddi3>
  800354:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800358:	0f be 80 28 12 80 00 	movsbl 0x801228(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800473:	ff 24 8d e0 12 80 00 	jmp    *0x8012e0(,%ecx,4)
  ...
  80053f:	c7 44 24 08 49 12 80 	movl   $0x801249,0x8(%esp)
  800546:	00 
  ...
  800571:	b8 39 12 80 00       	mov    $0x801239,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c40:	00 
  800c41:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800c48:	00 
  800c49:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c50:	00 
  800c51:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cd2:	00 
  800cd3:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800cda:	00 
  800cdb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce2:	00 
  800ce3:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d25:	00 
  800d26:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800d2d:	00 
  800d2e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d35:	00 
  800d36:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d78:	00 
  800d79:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800d80:	00 
  800d81:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d88:	00 
  800d89:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dcb:	00 
  800dcc:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800dd3:	00 
  800dd4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ddb:	00 
  800ddc:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e1e:	00 
  800e1f:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800e26:	00 
  800e27:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e2e:	00 
  800e2f:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e93:	00 
  800e94:	c7 44 24 08 68 14 80 	movl   $0x801468,0x8(%esp)
  800e9b:	00 
  800e9c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ea3:	00 
  800ea4:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
...
fork(void)
{
  ...
  800ebe:	c7 44 24 08 9f 14 80 	movl   $0x80149f,0x8(%esp)
  800ec5:	00 
  800ec6:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  800ecd:	00 
  800ece:	c7 04 24 93 14 80 00 	movl   $0x801493,(%esp)
  800ed5:	e8 93 f2 ff ff       	call   80016d <_panic>
...
sfork(void)
{
  ...
  800ee0:	c7 44 24 08 9e 14 80 	movl   $0x80149e,0x8(%esp)
  800ee7:	00 
  800ee8:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800eef:	00 
  800ef0:	c7 04 24 93 14 80 00 	movl   $0x801493,(%esp)
