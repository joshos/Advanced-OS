...
handler(struct UTrapframe *utf)
{
  ...
  800043:	c7 04 24 80 11 80 00 	movl   $0x801180,(%esp)
  80004a:	e8 fc 01 00 00       	call   80024b <cprintf>
  ...
  80007a:	c7 44 24 08 a0 11 80 	movl   $0x8011a0,0x8(%esp)
  800081:	00 
  800082:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  800089:	00 
  80008a:	c7 04 24 8a 11 80 00 	movl   $0x80118a,(%esp)
  800091:	e8 bc 00 00 00       	call   800152 <_panic>
	snprintf((char*) addr, 100, "this string was faulted in at %x", addr);
  800096:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  80009a:	c7 44 24 08 cc 11 80 	movl   $0x8011cc,0x8(%esp)
  8000a1:	00 
...
umain(int argc, char **argv)
{
  ...
  8000d9:	e8 e8 0a 00 00       	call   800bc6 <sys_cputs>
}
  8000de:	c9                   	leave  
  8000df:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  8000e4:	56                   	push   %esi
  8000e5:	53                   	push   %ebx
  8000e6:	83 ec 1c             	sub    $0x1c,%esp
  8000e9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  8000ec:	8b 7d 0c             	mov    0xc(%ebp),%edi
  ...
  8000ef:	e8 61 0b 00 00       	call   800c55 <sys_getenvid>
  ...
  8000ff:	c7 04 24 ed 11 80 00 	movl   $0x8011ed,(%esp)
  800106:	e8 40 01 00 00       	call   80024b <cprintf>
	thisenv = &envs[index];
  80010b:	6b f6 7c             	imul   $0x7c,%esi,%esi
  80010e:	81 c6 00 00 c0 ee    	add    $0xeec00000,%esi
  800114:	89 35 04 20 80 00    	mov    %esi,0x802004
	// save the name of the program so that panic() can use it
	if (argc > 0)
  80011a:	85 db                	test   %ebx,%ebx
  80011c:	7e 07                	jle    800125 <libmain+0x45>
		binaryname = argv[0];
  80011e:	8b 07                	mov    (%edi),%eax
  ...
  80012c:	e8 87 ff ff ff       	call   8000b8 <umain>

	// exit gracefully
	exit();
  800131:	e8 08 00 00 00       	call   80013e <exit>
}
...
exit(void)
{
  ...
  80014b:	e8 b3 0a 00 00       	call   800c03 <sys_env_destroy>
}
  800150:	c9                   	leave  
  800151:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800163:	e8 ed 0a 00 00       	call   800c55 <sys_getenvid>
  800168:	8b 55 0c             	mov    0xc(%ebp),%edx
  80016b:	89 54 24 10          	mov    %edx,0x10(%esp)
  80016f:	8b 55 08             	mov    0x8(%ebp),%edx
  800172:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800176:	89 74 24 08          	mov    %esi,0x8(%esp)
  80017a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80017e:	c7 04 24 08 12 80 00 	movl   $0x801208,(%esp)
  800185:	e8 c1 00 00 00       	call   80024b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80018a:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  80018e:	8b 45 10             	mov    0x10(%ebp),%eax
  800191:	89 04 24             	mov    %eax,(%esp)
  800194:	e8 51 00 00 00       	call   8001ea <vcprintf>
	cprintf("\n");
  800199:	c7 04 24 88 11 80 00 	movl   $0x801188,(%esp)
  8001a0:	e8 a6 00 00 00       	call   80024b <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8001a5:	cc                   	int3   
  8001a6:	eb fd                	jmp    8001a5 <_panic+0x53>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002df:	e8 fc 0b 00 00       	call   800ee0 <__udivdi3>
  ...
  80033f:	e8 cc 0c 00 00       	call   801010 <__umoddi3>
  800344:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800348:	0f be 80 2b 12 80 00 	movsbl 0x80122b(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80050f:	c7 44 24 08 43 12 80 	movl   $0x801243,0x8(%esp)
  800516:	00 
  ...
  80052f:	c7 44 24 08 4c 12 80 	movl   $0x80124c,0x8(%esp)
  800536:	00 
  ...
  800561:	b8 3c 12 80 00       	mov    $0x80123c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c30:	00 
  800c31:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800c38:	00 
  800c39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c40:	00 
  800c41:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
  800c48:	e8 05 f5 ff ff       	call   800152 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cc2:	00 
  800cc3:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800cca:	00 
  800ccb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd2:	00 
  800cd3:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
  800cda:	e8 73 f4 ff ff       	call   800152 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d15:	00 
  800d16:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800d1d:	00 
  800d1e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d25:	00 
  800d26:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
  800d2d:	e8 20 f4 ff ff       	call   800152 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d68:	00 
  800d69:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800d70:	00 
  800d71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d78:	00 
  800d79:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
  800d80:	e8 cd f3 ff ff       	call   800152 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dbb:	00 
  800dbc:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800dc3:	00 
  800dc4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dcb:	00 
  800dcc:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
  800dd3:	e8 7a f3 ff ff       	call   800152 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e0e:	00 
  800e0f:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800e16:	00 
  800e17:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e1e:	00 
  800e1f:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
  800e26:	e8 27 f3 ff ff       	call   800152 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e83:	00 
  800e84:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  800e8b:	00 
  800e8c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e93:	00 
  800e94:	c7 04 24 a5 14 80 00 	movl   $0x8014a5,(%esp)
  800e9b:	e8 b2 f2 ff ff       	call   800152 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800eb5:	75 1c                	jne    800ed3 <set_pgfault_handler+0x2b>
		// First time through!
		// LAB 4: Your code here.
		panic("set_pgfault_handler not implemented");
  800eb7:	c7 44 24 08 b4 14 80 	movl   $0x8014b4,0x8(%esp)
  800ebe:	00 
  800ebf:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  800ec6:	00 
  800ec7:	c7 04 24 d8 14 80 00 	movl   $0x8014d8,(%esp)
  800ece:	e8 7f f2 ff ff       	call   800152 <_panic>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  800ed3:	8b 45 08             	mov    0x8(%ebp),%eax
  800ed6:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800edb:	c9                   	leave  
  800edc:	c3                   	ret    
