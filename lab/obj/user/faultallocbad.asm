...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800168:	c7 04 24 38 12 80 00 	movl   $0x801238,(%esp)
  ...
  80017e:	e8 51 00 00 00       	call   8001d4 <vcprintf>
	cprintf("\n");
  800183:	c7 04 24 09 15 80 00 	movl   $0x801509,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002bf:	e8 6c 0c 00 00       	call   800f30 <__udivdi3>
  ...
  80031f:	e8 3c 0d 00 00       	call   801060 <__umoddi3>
  800324:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800328:	0f be 80 5c 12 80 00 	movsbl 0x80125c(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800443:	ff 24 8d 20 13 80 00 	jmp    *0x801320(,%ecx,4)
  ...
  80050f:	c7 44 24 08 7d 12 80 	movl   $0x80127d,0x8(%esp)
  800516:	00 
  ...
  800541:	b8 6d 12 80 00       	mov    $0x80126d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c10:	00 
  800c11:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800c18:	00 
  800c19:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c20:	00 
  800c21:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ca2:	00 
  800ca3:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800caa:	00 
  800cab:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb2:	00 
  800cb3:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cf5:	00 
  800cf6:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800cfd:	00 
  800cfe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d05:	00 
  800d06:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d48:	00 
  800d49:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800d50:	00 
  800d51:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d58:	00 
  800d59:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d9b:	00 
  800d9c:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800da3:	00 
  800da4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dab:	00 
  800dac:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dee:	00 
  800def:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800df6:	00 
  800df7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dfe:	00 
  800dff:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e63:	00 
  800e64:	c7 44 24 08 a8 14 80 	movl   $0x8014a8,0x8(%esp)
  800e6b:	00 
  800e6c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e73:	00 
  800e74:	c7 04 24 c5 14 80 00 	movl   $0x8014c5,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e95:	75 68                	jne    800eff <set_pgfault_handler+0x77>
	{
		// First time through!
  ...
  800e9c:	8b 40 48             	mov    0x48(%eax),%eax
  ...
  800eb9:	79 20                	jns    800edb <set_pgfault_handler+0x53>
			panic("panic in sys_page_alloc: %e", r);
  800ebb:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800ebf:	c7 44 24 08 d3 14 80 	movl   $0x8014d3,0x8(%esp)
  800ec6:	00 
  800ec7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ece:	00 
  800ecf:	c7 04 24 ef 14 80 00 	movl   $0x8014ef,(%esp)
  800ed6:	e8 61 f2 ff ff       	call   80013c <_panic>
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  800edb:	a1 04 20 80 00       	mov    0x802004,%eax
  800ee0:	8b 40 48             	mov    0x48(%eax),%eax
  800ee3:	c7 44 24 04 09 0f 80 	movl   $0x800f09,0x4(%esp)
  800eea:	00 
  800eeb:	89 04 24             	mov    %eax,(%esp)
  800eee:	e8 cd fe ff ff       	call   800dc0 <sys_env_set_pgfault_upcall>
		cprintf("\nUp call set\n");
  800ef3:	c7 04 24 fd 14 80 00 	movl   $0x8014fd,(%esp)
  800efa:	e8 36 f3 ff ff       	call   800235 <cprintf>
  ...
  800f02:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800f07:	c9                   	leave  
  800f08:	c3                   	ret    
...
_pgfault_upcall:
  ...
  800f18:	89 e5                	mov    %esp,%ebp
	...
	movl 0x30(%esp),%esp
  800f1a:	8b 64 24 30          	mov    0x30(%esp),%esp
  ...
  800f1e:	50                   	push   %eax
	...
	movl %esp, 0x30(%ebp)
  800f1f:	89 65 30             	mov    %esp,0x30(%ebp)
