...
exit(void)
{
  ...
  8000ba:	e8 54 0a 00 00       	call   800b13 <sys_env_destroy>
}
  8000bf:	c9                   	leave  
  8000c0:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000ee:	e8 e3 09 00 00       	call   800ad6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80013f:	e8 aa 01 00 00       	call   8002ee <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800157:	e8 7a 09 00 00       	call   800ad6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 98 0e 80 00 	movsbl 0x800e98(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80041f:	c7 44 24 08 b0 0e 80 	movl   $0x800eb0,0x8(%esp)
  800426:	00 
  ...
  80043f:	c7 44 24 08 b9 0e 80 	movl   $0x800eb9,0x8(%esp)
  800446:	00 
  ...
  800471:	b8 a9 0e 80 00       	mov    $0x800ea9,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800bb7:	e8 a8 f5 ff ff       	call   800164 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800bbc:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800bc0:	8b 45 10             	mov    0x10(%ebp),%eax
  800bc3:	89 04 24             	mov    %eax,(%esp)
  800bc6:	e8 38 f5 ff ff       	call   800103 <vcprintf>
	cprintf("\n");
  800bcb:	c7 04 24 8c 0e 80 00 	movl   $0x800e8c,(%esp)
  800bd2:	e8 8d f5 ff ff       	call   800164 <cprintf>
