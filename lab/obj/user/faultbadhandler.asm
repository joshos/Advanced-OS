...
umain(int argc, char **argv)
{
  ...
  800050:	e8 7e 0b 00 00       	call   800bd3 <sys_page_alloc>
	sys_env_set_pgfault_upcall(0, (void*) 0xDeadBeef);
  800055:	c7 44 24 04 ef be ad 	movl   $0xdeadbeef,0x4(%esp)
  80005c:	de 
  80005d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800064:	e8 b7 0c 00 00       	call   800d20 <sys_env_set_pgfault_upcall>
	*(int*)0 = 0;
...
libmain(int argc, char **argv)
{
  ...
  800079:	56                   	push   %esi
  80007a:	53                   	push   %ebx
  80007b:	83 ec 1c             	sub    $0x1c,%esp
  80007e:	8b 5d 08             	mov    0x8(%ebp),%ebx
  800081:	8b 7d 0c             	mov    0xc(%ebp),%edi
  ...
  800084:	e8 0c 0b 00 00       	call   800b95 <sys_getenvid>
  ...
  800094:	c7 04 24 e0 10 80 00 	movl   $0x8010e0,(%esp)
  80009b:	e8 ea 00 00 00       	call   80018a <cprintf>
	thisenv = &envs[index];
  8000a0:	6b f6 7c             	imul   $0x7c,%esi,%esi
  8000a3:	81 c6 00 00 c0 ee    	add    $0xeec00000,%esi
  8000a9:	89 35 04 20 80 00    	mov    %esi,0x802004
	// save the name of the program so that panic() can use it
	if (argc > 0)
  8000af:	85 db                	test   %ebx,%ebx
  8000b1:	7e 07                	jle    8000ba <libmain+0x45>
		binaryname = argv[0];
  ...
  8000b5:	a3 00 20 80 00       	mov    %eax,0x802000
	...
	umain(argc, argv);
  8000ba:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8000be:	89 1c 24             	mov    %ebx,(%esp)
  8000c1:	e8 6d ff ff ff       	call   800033 <umain>

	// exit gracefully
	exit();
  8000c6:	e8 08 00 00 00       	call   8000d3 <exit>
}
  8000cb:	83 c4 1c             	add    $0x1c,%esp
  8000ce:	5b                   	pop    %ebx
  8000cf:	5e                   	pop    %esi
  8000d0:	5f                   	pop    %edi
  8000d1:	5d                   	pop    %ebp
...
exit(void)
{
  ...
  8000e0:	e8 5e 0a 00 00       	call   800b43 <sys_env_destroy>
}
  8000e5:	c9                   	leave  
  8000e6:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  800114:	e8 ed 09 00 00       	call   800b06 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800165:	e8 b4 01 00 00       	call   80031e <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80017d:	e8 84 09 00 00       	call   800b06 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80021f:	e8 1c 0c 00 00       	call   800e40 <__udivdi3>
  ...
  80027f:	e8 ec 0c 00 00       	call   800f70 <__umoddi3>
  800284:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800288:	0f be 80 f9 10 80 00 	movsbl 0x8010f9(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003a3:	ff 24 8d c0 11 80 00 	jmp    *0x8011c0(,%ecx,4)
  ...
  80046f:	c7 44 24 08 1a 11 80 	movl   $0x80111a,0x8(%esp)
  800476:	00 
  ...
  8004a1:	b8 0a 11 80 00       	mov    $0x80110a,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b70:	00 
  800b71:	c7 44 24 08 48 13 80 	movl   $0x801348,0x8(%esp)
  800b78:	00 
  800b79:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b80:	00 
  800b81:	c7 04 24 65 13 80 00 	movl   $0x801365,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c02:	00 
  800c03:	c7 44 24 08 48 13 80 	movl   $0x801348,0x8(%esp)
  800c0a:	00 
  800c0b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c12:	00 
  800c13:	c7 04 24 65 13 80 00 	movl   $0x801365,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c55:	00 
  800c56:	c7 44 24 08 48 13 80 	movl   $0x801348,0x8(%esp)
  800c5d:	00 
  800c5e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c65:	00 
  800c66:	c7 04 24 65 13 80 00 	movl   $0x801365,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800ca8:	00 
  800ca9:	c7 44 24 08 48 13 80 	movl   $0x801348,0x8(%esp)
  800cb0:	00 
  800cb1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb8:	00 
  800cb9:	c7 04 24 65 13 80 00 	movl   $0x801365,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cfb:	00 
  800cfc:	c7 44 24 08 48 13 80 	movl   $0x801348,0x8(%esp)
  800d03:	00 
  800d04:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d0b:	00 
  800d0c:	c7 04 24 65 13 80 00 	movl   $0x801365,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d4e:	00 
  800d4f:	c7 44 24 08 48 13 80 	movl   $0x801348,0x8(%esp)
  800d56:	00 
  800d57:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d5e:	00 
  800d5f:	c7 04 24 65 13 80 00 	movl   $0x801365,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800dc3:	00 
  800dc4:	c7 44 24 08 48 13 80 	movl   $0x801348,0x8(%esp)
  800dcb:	00 
  800dcc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dd3:	00 
  800dd4:	c7 04 24 65 13 80 00 	movl   $0x801365,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e14:	c7 04 24 74 13 80 00 	movl   $0x801374,(%esp)
  800e1b:	e8 6a f3 ff ff       	call   80018a <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e20:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800e24:	8b 45 10             	mov    0x10(%ebp),%eax
  800e27:	89 04 24             	mov    %eax,(%esp)
  800e2a:	e8 fa f2 ff ff       	call   800129 <vcprintf>
	cprintf("\n");
  800e2f:	c7 04 24 ed 10 80 00 	movl   $0x8010ed,(%esp)
  800e36:	e8 4f f3 ff ff       	call   80018a <cprintf>
