...
umain(int argc, char **argv)
{
  ...
  800048:	e8 61 00 00 00       	call   8000ae <sys_cputs>
}
  80004d:	c9                   	leave  
  80004e:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  80005d:	e8 db 00 00 00       	call   80013d <sys_getenvid>
  ...
  800079:	7e 07                	jle    800082 <libmain+0x33>
		binaryname = argv[0];
  ...
  80007d:	a3 00 20 80 00       	mov    %eax,0x802000
	...
	umain(argc, argv);
  800082:	89 74 24 04          	mov    %esi,0x4(%esp)
  800086:	89 1c 24             	mov    %ebx,(%esp)
  800089:	e8 a5 ff ff ff       	call   800033 <umain>

	// exit gracefully
	exit();
  80008e:	e8 07 00 00 00       	call   80009a <exit>
}
...
exit(void)
{
  ...
  80009d:	83 ec 18             	sub    $0x18,%esp
	sys_env_destroy(0);
  8000a0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000a7:	e8 3f 00 00 00       	call   8000eb <sys_env_destroy>
}
  8000ac:	c9                   	leave  
  8000ad:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  80010b:	7e 28                	jle    800135 <sys_env_destroy+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  80010d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800111:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800118:	00 
  800119:	c7 44 24 08 6a 0e 80 	movl   $0x800e6a,0x8(%esp)
  800120:	00 
  800121:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800128:	00 
  800129:	c7 04 24 87 0e 80 00 	movl   $0x800e87,(%esp)
  800130:	e8 27 00 00 00       	call   80015c <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80016d:	e8 cb ff ff ff       	call   80013d <sys_getenvid>
  ...
  800188:	c7 04 24 98 0e 80 00 	movl   $0x800e98,(%esp)
  80018f:	e8 c1 00 00 00       	call   800255 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800194:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800198:	8b 45 10             	mov    0x10(%ebp),%eax
  80019b:	89 04 24             	mov    %eax,(%esp)
  80019e:	e8 51 00 00 00       	call   8001f4 <vcprintf>
	cprintf("\n");
  8001a3:	c7 04 24 bc 0e 80 00 	movl   $0x800ebc,(%esp)
  8001aa:	e8 a6 00 00 00       	call   800255 <cprintf>
...
putch(int ch, struct printbuf *b)
{
  ...
  8001df:	e8 ca fe ff ff       	call   8000ae <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800248:	e8 61 fe ff ff       	call   8000ae <sys_cputs>
