...
top:
  ...
  800070:	e8 3e 02 00 00       	call   8002b3 <cprintf>
  ...
  80009b:	e8 1a 01 00 00       	call   8001ba <_panic>
	if (id == 0)
...
umain(int argc, char **argv)
{
  ...
  800114:	e8 a1 00 00 00       	call   8001ba <_panic>
	if (id == 0)
...
libmain(int argc, char **argv)
{
  ...
  80014c:	56                   	push   %esi
  80014d:	53                   	push   %ebx
  80014e:	83 ec 1c             	sub    $0x1c,%esp
  800151:	8b 5d 08             	mov    0x8(%ebp),%ebx
  800154:	8b 7d 0c             	mov    0xc(%ebp),%edi
  ...
  800157:	e8 59 0b 00 00       	call   800cb5 <sys_getenvid>
	int index = envid & (1023);
  80015c:	25 ff 03 00 00       	and    $0x3ff,%eax
  800161:	89 c6                	mov    %eax,%esi
	cprintf("Value of x:%x\n",index);
  800163:	89 44 24 04          	mov    %eax,0x4(%esp)
  800167:	c7 04 24 83 12 80 00 	movl   $0x801283,(%esp)
  80016e:	e8 40 01 00 00       	call   8002b3 <cprintf>
	thisenv = &envs[index];
  800173:	6b f6 7c             	imul   $0x7c,%esi,%esi
  800176:	81 c6 00 00 c0 ee    	add    $0xeec00000,%esi
  80017c:	89 35 04 20 80 00    	mov    %esi,0x802004
	// save the name of the program so that panic() can use it
	if (argc > 0)
  800182:	85 db                	test   %ebx,%ebx
  800184:	7e 07                	jle    80018d <libmain+0x45>
		binaryname = argv[0];
  800186:	8b 07                	mov    (%edi),%eax
  800188:	a3 00 20 80 00       	mov    %eax,0x802000

	// call user main routine
	umain(argc, argv);
  80018d:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800191:	89 1c 24             	mov    %ebx,(%esp)
  800194:	e8 4d ff ff ff       	call   8000e6 <umain>

	// exit gracefully
	exit();
  800199:	e8 08 00 00 00       	call   8001a6 <exit>
}
  80019e:	83 c4 1c             	add    $0x1c,%esp
  8001a1:	5b                   	pop    %ebx
  8001a2:	5e                   	pop    %esi
  8001a3:	5f                   	pop    %edi
  8001a4:	5d                   	pop    %ebp
...
exit(void)
{
  ...
  8001a9:	83 ec 18             	sub    $0x18,%esp
	sys_env_destroy(0);
  8001ac:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8001b3:	e8 ab 0a 00 00       	call   800c63 <sys_env_destroy>
}
  8001b8:	c9                   	leave  
  8001b9:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001bd:	56                   	push   %esi
  8001be:	53                   	push   %ebx
  8001bf:	83 ec 20             	sub    $0x20,%esp
	va_list ap;

	va_start(ap, fmt);
  8001c2:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8001c5:	8b 35 00 20 80 00    	mov    0x802000,%esi
  8001cb:	e8 e5 0a 00 00       	call   800cb5 <sys_getenvid>
  8001d0:	8b 55 0c             	mov    0xc(%ebp),%edx
  8001d3:	89 54 24 10          	mov    %edx,0x10(%esp)
  8001d7:	8b 55 08             	mov    0x8(%ebp),%edx
  8001da:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8001de:	89 74 24 08          	mov    %esi,0x8(%esp)
  8001e2:	89 44 24 04          	mov    %eax,0x4(%esp)
  8001e6:	c7 04 24 9c 12 80 00 	movl   $0x80129c,(%esp)
  8001ed:	e8 c1 00 00 00       	call   8002b3 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8001f2:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8001f6:	8b 45 10             	mov    0x10(%ebp),%eax
  8001f9:	89 04 24             	mov    %eax,(%esp)
  8001fc:	e8 51 00 00 00       	call   800252 <vcprintf>
	cprintf("\n");
  800201:	c7 04 24 90 12 80 00 	movl   $0x801290,(%esp)
  800208:	e8 a6 00 00 00       	call   8002b3 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  80020d:	cc                   	int3   
  80020e:	eb fd                	jmp    80020d <_panic+0x53>
...
putch(int ch, struct printbuf *b)
{
  ...
  800217:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  80021a:	8b 13                	mov    (%ebx),%edx
  80021c:	8d 42 01             	lea    0x1(%edx),%eax
  80021f:	89 03                	mov    %eax,(%ebx)
  800221:	8b 4d 08             	mov    0x8(%ebp),%ecx
  800224:	88 4c 13 08          	mov    %cl,0x8(%ebx,%edx,1)
	if (b->idx == 256-1) {
  800228:	3d ff 00 00 00       	cmp    $0xff,%eax
  80022d:	75 19                	jne    800248 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  80022f:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800236:	00 
  800237:	8d 43 08             	lea    0x8(%ebx),%eax
  80023a:	89 04 24             	mov    %eax,(%esp)
  80023d:	e8 e4 09 00 00       	call   800c26 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800255:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;
  ...
  800272:	89 44 24 0c          	mov    %eax,0xc(%esp)
  ...
  800287:	c7 04 24 10 02 80 00 	movl   $0x800210,(%esp)
  80028e:	e8 ab 01 00 00       	call   80043e <vprintfmt>
	sys_cputs(b.buf, b.idx);
  800293:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  800299:	89 44 24 04          	mov    %eax,0x4(%esp)
  80029d:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  8002a3:	89 04 24             	mov    %eax,(%esp)
  8002a6:	e8 7b 09 00 00       	call   800c26 <sys_cputs>
...
cprintf(const char *fmt, ...)
{
  ...
  8002c6:	e8 87 ff ff ff       	call   800252 <vcprintf>
	va_end(ap);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8003a8:	0f be 80 c0 12 80 00 	movsbl 0x8012c0(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80056f:	c7 44 24 08 d8 12 80 	movl   $0x8012d8,0x8(%esp)
  800576:	00 
  ...
  80058f:	c7 44 24 08 e1 12 80 	movl   $0x8012e1,0x8(%esp)
  800596:	00 
  ...
  8005c1:	b8 d1 12 80 00       	mov    $0x8012d1,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ca8:	e8 0d f5 ff ff       	call   8001ba <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d3a:	e8 7b f4 ff ff       	call   8001ba <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d8d:	e8 28 f4 ff ff       	call   8001ba <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800de0:	e8 d5 f3 ff ff       	call   8001ba <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e33:	e8 82 f3 ff ff       	call   8001ba <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e86:	e8 2f f3 ff ff       	call   8001ba <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800efb:	e8 ba f2 ff ff       	call   8001ba <_panic>
...
fork(void)
{
  ...
  800f25:	e8 90 f2 ff ff       	call   8001ba <_panic>
...
sfork(void)
{
  ...
  800f47:	e8 6e f2 ff ff       	call   8001ba <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800f69:	e8 4c f2 ff ff       	call   8001ba <_panic>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800f8b:	e8 2a f2 ff ff       	call   8001ba <_panic>
