...
_pgfault_upcall:
  ...
  8003ac:	50                   	push   %eax
	...
	movl %esp, 0x30(%ebp)
  8003ad:	89 65 30             	mov    %esp,0x30(%ebp)

	//restore the esp to the exception esp in UXSTACKTOP

	movl %ebp, %esp
  8003b0:	89 ec                	mov    %ebp,%esp
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8003e7:	c7 04 24 78 11 80 00 	movl   $0x801178,(%esp)
  ...
  8003fd:	e8 51 00 00 00       	call   800453 <vcprintf>
	cprintf("\n");
  800402:	c7 04 24 1e 14 80 00 	movl   $0x80141e,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80053f:	e8 6c 09 00 00       	call   800eb0 <__udivdi3>
  ...
  80059f:	e8 3c 0a 00 00       	call   800fe0 <__umoddi3>
  8005a4:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8005a8:	0f be 80 9c 11 80 00 	movsbl 0x80119c(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8006c3:	ff 24 8d 60 12 80 00 	jmp    *0x801260(,%ecx,4)
  ...
  80078f:	c7 44 24 08 bd 11 80 	movl   $0x8011bd,0x8(%esp)
  800796:	00 
  ...
  8007c1:	b8 ad 11 80 00       	mov    $0x8011ad,%eax
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e2c:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  800e33:	75 68                	jne    800e9d <set_pgfault_handler+0x77>
	{
		// First time through!
		// LAB 4: Your code here.
		int r;
		if((r = sys_page_alloc(thisenv->env_id, (void *)(UXSTACKTOP-PGSIZE), PTE_P | PTE_U | PTE_W)) < 0)
  800e35:	a1 04 20 80 00       	mov    0x802004,%eax
  ...
  800e57:	79 20                	jns    800e79 <set_pgfault_handler+0x53>
			panic("panic in sys_page_alloc: %e", r);
  800e59:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800e5d:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800e64:	00 
  800e65:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e6c:	00 
  800e6d:	c7 04 24 04 14 80 00 	movl   $0x801404,(%esp)
  800e74:	e8 42 f5 ff ff       	call   8003bb <_panic>
  ...
  800e8c:	e8 3e f4 ff ff       	call   8002cf <sys_env_set_pgfault_upcall>
		cprintf("\nUp call set\n");
  800e91:	c7 04 24 12 14 80 00 	movl   $0x801412,(%esp)
  800e98:	e8 17 f6 ff ff       	call   8004b4 <cprintf>
  ...
  800ea0:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800ea5:	c9                   	leave  
  800ea6:	c3                   	ret    
