...
umain(int argc, char **argv)
{
  ...
  80004d:	e8 61 01 00 00       	call   8001b3 <cprintf>
	for (i = 0; i < 5; i++) {
  ...
  800073:	e8 3b 01 00 00       	call   8001b3 <cprintf>
umain(int argc, char **argv)
{
	int i;
  ...
  800093:	e8 1b 01 00 00       	call   8001b3 <cprintf>
}
...
libmain(int argc, char **argv)
{
  ...
  8000aa:	8b 7d 0c             	mov    0xc(%ebp),%edi
  ...
  8000ad:	e8 03 0b 00 00       	call   800bb5 <sys_getenvid>
  ...
  8000bd:	c7 04 24 6b 11 80 00 	movl   $0x80116b,(%esp)
  8000c4:	e8 ea 00 00 00       	call   8001b3 <cprintf>
	thisenv = &envs[index];
  8000c9:	6b f6 7c             	imul   $0x7c,%esi,%esi
  8000cc:	81 c6 00 00 c0 ee    	add    $0xeec00000,%esi
  8000d2:	89 35 04 20 80 00    	mov    %esi,0x802004
	// save the name of the program so that panic() can use it
	if (argc > 0)
  8000d8:	85 db                	test   %ebx,%ebx
  8000da:	7e 07                	jle    8000e3 <libmain+0x45>
		binaryname = argv[0];
  8000dc:	8b 07                	mov    (%edi),%eax
  8000de:	a3 00 20 80 00       	mov    %eax,0x802000

	// call user main routine
	umain(argc, argv);
  8000e3:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
exit(void)
{
  ...
  800109:	e8 55 0a 00 00       	call   800b63 <sys_env_destroy>
}
  80010e:	c9                   	leave  
  80010f:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  80013d:	e8 e4 09 00 00       	call   800b26 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80018e:	e8 ab 01 00 00       	call   80033e <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  8001a6:	e8 7b 09 00 00       	call   800b26 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002a8:	0f be 80 84 11 80 00 	movsbl 0x801184(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80046f:	c7 44 24 08 9c 11 80 	movl   $0x80119c,0x8(%esp)
  800476:	00 
  ...
  80048f:	c7 44 24 08 a5 11 80 	movl   $0x8011a5,0x8(%esp)
  800496:	00 
  ...
  8004c1:	b8 95 11 80 00       	mov    $0x801195,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e3b:	e8 73 f3 ff ff       	call   8001b3 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e40:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800e44:	8b 45 10             	mov    0x10(%ebp),%eax
  800e47:	89 04 24             	mov    %eax,(%esp)
  800e4a:	e8 03 f3 ff ff       	call   800152 <vcprintf>
	cprintf("\n");
  800e4f:	c7 04 24 78 11 80 00 	movl   $0x801178,(%esp)
  800e56:	e8 58 f3 ff ff       	call   8001b3 <cprintf>
