...
sys_env_destroy(envid_t envid)
{
  ...
  800b80:	00 
  800b81:	c7 44 24 08 a8 13 80 	movl   $0x8013a8,0x8(%esp)
  800b88:	00 
  800b89:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b90:	00 
  800b91:	c7 04 24 c5 13 80 00 	movl   $0x8013c5,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c12:	00 
  800c13:	c7 44 24 08 a8 13 80 	movl   $0x8013a8,0x8(%esp)
  800c1a:	00 
  800c1b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c22:	00 
  800c23:	c7 04 24 c5 13 80 00 	movl   $0x8013c5,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c65:	00 
  800c66:	c7 44 24 08 a8 13 80 	movl   $0x8013a8,0x8(%esp)
  800c6d:	00 
  800c6e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c75:	00 
  800c76:	c7 04 24 c5 13 80 00 	movl   $0x8013c5,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cb8:	00 
  800cb9:	c7 44 24 08 a8 13 80 	movl   $0x8013a8,0x8(%esp)
  800cc0:	00 
  800cc1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cc8:	00 
  800cc9:	c7 04 24 c5 13 80 00 	movl   $0x8013c5,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d0b:	00 
  800d0c:	c7 44 24 08 a8 13 80 	movl   $0x8013a8,0x8(%esp)
  800d13:	00 
  800d14:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d1b:	00 
  800d1c:	c7 04 24 c5 13 80 00 	movl   $0x8013c5,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d5e:	00 
  800d5f:	c7 44 24 08 a8 13 80 	movl   $0x8013a8,0x8(%esp)
  800d66:	00 
  800d67:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d6e:	00 
  800d6f:	c7 04 24 c5 13 80 00 	movl   $0x8013c5,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800dd3:	00 
  800dd4:	c7 44 24 08 a8 13 80 	movl   $0x8013a8,0x8(%esp)
  800ddb:	00 
  800ddc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de3:	00 
  800de4:	c7 04 24 c5 13 80 00 	movl   $0x8013c5,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e24:	c7 04 24 d4 13 80 00 	movl   $0x8013d4,(%esp)
  ...
  800e3a:	e8 fd f2 ff ff       	call   80013c <vcprintf>
	cprintf("\n");
  800e3f:	c7 04 24 f8 13 80 00 	movl   $0x8013f8,(%esp)
