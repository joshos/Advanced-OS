...
libmain(int argc, char **argv)
{
  ...
  80004c:	e8 db 00 00 00       	call   80012c <sys_getenvid>
  800051:	25 ff 03 00 00       	and    $0x3ff,%eax
  800056:	8d 04 40             	lea    (%eax,%eax,2),%eax
  800059:	c1 e0 05             	shl    $0x5,%eax
  ...
  80006c:	a3 00 20 80 00       	mov    %eax,0x802000
	...
	umain(argc, argv);
  800071:	89 74 24 04          	mov    %esi,0x4(%esp)
  800075:	89 1c 24             	mov    %ebx,(%esp)
  800078:	e8 b6 ff ff ff       	call   800033 <umain>

	// exit gracefully
	exit();
  80007d:	e8 07 00 00 00       	call   800089 <exit>
}
...
exit(void)
{
  ...
  800096:	e8 3f 00 00 00       	call   8000da <sys_env_destroy>
}
  80009b:	c9                   	leave  
  80009c:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  8000fa:	7e 28                	jle    800124 <sys_env_destroy+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8000fc:	89 44 24 10          	mov    %eax,0x10(%esp)
  800100:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800107:	00 
  800108:	c7 44 24 08 6a 0e 80 	movl   $0x800e6a,0x8(%esp)
  80010f:	00 
  800110:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800117:	00 
  800118:	c7 04 24 87 0e 80 00 	movl   $0x800e87,(%esp)
  80011f:	e8 27 00 00 00       	call   80014b <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80015c:	e8 cb ff ff ff       	call   80012c <sys_getenvid>
  ...
  800177:	c7 04 24 98 0e 80 00 	movl   $0x800e98,(%esp)
  ...
  80018d:	e8 51 00 00 00       	call   8001e3 <vcprintf>
	cprintf("\n");
  800192:	c7 04 24 bc 0e 80 00 	movl   $0x800ebc,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8001ce:	e8 ca fe ff ff       	call   80009d <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800237:	e8 61 fe ff ff       	call   80009d <sys_cputs>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800453:	ff 24 8d 60 0f 80 00 	jmp    *0x800f60(,%ecx,4)
  ...
  80051f:	c7 44 24 08 df 0e 80 	movl   $0x800edf,0x8(%esp)
  800526:	00 
  ...
  800551:	b8 cf 0e 80 00       	mov    $0x800ecf,%eax
