...
libmain(int argc, char **argv)
{
  ...
  800042:	56                   	push   %esi
  800043:	53                   	push   %ebx
  800044:	83 ec 1c             	sub    $0x1c,%esp
  800047:	8b 5d 08             	mov    0x8(%ebp),%ebx
  80004a:	8b 7d 0c             	mov    0xc(%ebp),%edi
  ...
  80004d:	e8 03 0b 00 00       	call   800b55 <sys_getenvid>
	int index = envid & (1023);
  800052:	25 ff 03 00 00       	and    $0x3ff,%eax
  800057:	89 c6                	mov    %eax,%esi
	cprintf("Value of x:%x\n",index);
  800059:	89 44 24 04          	mov    %eax,0x4(%esp)
  80005d:	c7 04 24 a0 10 80 00 	movl   $0x8010a0,(%esp)
  800064:	e8 ea 00 00 00       	call   800153 <cprintf>
	thisenv = &envs[index];
  800069:	6b f6 7c             	imul   $0x7c,%esi,%esi
  80006c:	81 c6 00 00 c0 ee    	add    $0xeec00000,%esi
  800072:	89 35 04 20 80 00    	mov    %esi,0x802004
	// save the name of the program so that panic() can use it
	if (argc > 0)
  800078:	85 db                	test   %ebx,%ebx
  80007a:	7e 07                	jle    800083 <libmain+0x45>
		binaryname = argv[0];
  80007c:	8b 07                	mov    (%edi),%eax
  80007e:	a3 00 20 80 00       	mov    %eax,0x802000

	// call user main routine
	umain(argc, argv);
  800083:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
exit(void)
{
  ...
  8000a9:	e8 55 0a 00 00       	call   800b03 <sys_env_destroy>
}
  8000ae:	c9                   	leave  
  8000af:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000dd:	e8 e4 09 00 00       	call   800ac6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80012e:	e8 ab 01 00 00       	call   8002de <vprintfmt>
	sys_cputs(b.buf, b.idx);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 b9 10 80 00 	movsbl 0x8010b9(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80040f:	c7 44 24 08 d1 10 80 	movl   $0x8010d1,0x8(%esp)
  800416:	00 
  ...
  80042f:	c7 44 24 08 da 10 80 	movl   $0x8010da,0x8(%esp)
  800436:	00 
  ...
  800461:	b8 ca 10 80 00       	mov    $0x8010ca,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b30:	00 
  800b31:	c7 44 24 08 08 13 80 	movl   $0x801308,0x8(%esp)
  800b38:	00 
  800b39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b40:	00 
  800b41:	c7 04 24 25 13 80 00 	movl   $0x801325,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bc2:	00 
  800bc3:	c7 44 24 08 08 13 80 	movl   $0x801308,0x8(%esp)
  800bca:	00 
  800bcb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bd2:	00 
  800bd3:	c7 04 24 25 13 80 00 	movl   $0x801325,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c15:	00 
  800c16:	c7 44 24 08 08 13 80 	movl   $0x801308,0x8(%esp)
  800c1d:	00 
  800c1e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c25:	00 
  800c26:	c7 04 24 25 13 80 00 	movl   $0x801325,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c68:	00 
  800c69:	c7 44 24 08 08 13 80 	movl   $0x801308,0x8(%esp)
  800c70:	00 
  800c71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c78:	00 
  800c79:	c7 04 24 25 13 80 00 	movl   $0x801325,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cbb:	00 
  800cbc:	c7 44 24 08 08 13 80 	movl   $0x801308,0x8(%esp)
  800cc3:	00 
  800cc4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ccb:	00 
  800ccc:	c7 04 24 25 13 80 00 	movl   $0x801325,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d0e:	00 
  800d0f:	c7 44 24 08 08 13 80 	movl   $0x801308,0x8(%esp)
  800d16:	00 
  800d17:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d1e:	00 
  800d1f:	c7 04 24 25 13 80 00 	movl   $0x801325,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800d83:	00 
  800d84:	c7 44 24 08 08 13 80 	movl   $0x801308,0x8(%esp)
  800d8b:	00 
  800d8c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d93:	00 
  800d94:	c7 04 24 25 13 80 00 	movl   $0x801325,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800dd4:	c7 04 24 34 13 80 00 	movl   $0x801334,(%esp)
  ...
  800dea:	e8 03 f3 ff ff       	call   8000f2 <vcprintf>
	cprintf("\n");
  800def:	c7 04 24 ad 10 80 00 	movl   $0x8010ad,(%esp)
  800df6:	e8 58 f3 ff ff       	call   800153 <cprintf>
