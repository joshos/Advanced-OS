...
sys_env_destroy(envid_t envid)
{
  ...
  80010b:	00 
  80010c:	c7 44 24 08 6a 0e 80 	movl   $0x800e6a,0x8(%esp)
  800113:	00 
  800114:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80011b:	00 
  80011c:	c7 04 24 87 0e 80 00 	movl   $0x800e87,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80017b:	c7 04 24 98 0e 80 00 	movl   $0x800e98,(%esp)
  ...
  800191:	e8 51 00 00 00       	call   8001e7 <vcprintf>
	cprintf("\n");
  800196:	c7 04 24 bc 0e 80 00 	movl   $0x800ebc,(%esp)
