...
handler(struct UTrapframe *utf)
{
  ...
  800059:	c7 04 24 40 11 80 00 	movl   $0x801140,(%esp)
  800060:	e8 42 01 00 00       	call   8001a7 <cprintf>
	sys_env_destroy(sys_getenvid());
  800065:	e8 4b 0b 00 00       	call   800bb5 <sys_getenvid>
  80006a:	89 04 24             	mov    %eax,(%esp)
  80006d:	e8 f1 0a 00 00       	call   800b63 <sys_env_destroy>
}
  800072:	c9                   	leave  
  800073:	c3                   	ret    
...
umain(int argc, char **argv)
{
  ...
  800081:	e8 82 0d 00 00       	call   800e08 <set_pgfault_handler>
	*(int*)0xDeadBeef = 0;
...
libmain(int argc, char **argv)
{
  ...
  80009e:	8b 7d 0c             	mov    0xc(%ebp),%edi
  ...
  8000a1:	e8 0f 0b 00 00       	call   800bb5 <sys_getenvid>
  ...
  8000b1:	c7 04 24 5c 11 80 00 	movl   $0x80115c,(%esp)
  8000b8:	e8 ea 00 00 00       	call   8001a7 <cprintf>
	thisenv = &envs[index];
  8000bd:	6b f6 7c             	imul   $0x7c,%esi,%esi
  8000c0:	81 c6 00 00 c0 ee    	add    $0xeec00000,%esi
  8000c6:	89 35 04 20 80 00    	mov    %esi,0x802004
	// save the name of the program so that panic() can use it
	if (argc > 0)
  8000cc:	85 db                	test   %ebx,%ebx
  8000ce:	7e 07                	jle    8000d7 <libmain+0x45>
		binaryname = argv[0];
  8000d0:	8b 07                	mov    (%edi),%eax
  8000d2:	a3 00 20 80 00       	mov    %eax,0x802000

	// call user main routine
	umain(argc, argv);
  8000d7:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8000db:	89 1c 24             	mov    %ebx,(%esp)
  8000de:	e8 91 ff ff ff       	call   800074 <umain>

	// exit gracefully
	exit();
  8000e3:	e8 08 00 00 00       	call   8000f0 <exit>
}
  8000e8:	83 c4 1c             	add    $0x1c,%esp
  8000eb:	5b                   	pop    %ebx
  8000ec:	5e                   	pop    %esi
  8000ed:	5f                   	pop    %edi
  8000ee:	5d                   	pop    %ebp
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80029f:	e8 2c 0d 00 00       	call   800fd0 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800ba8:	e8 90 02 00 00       	call   800e3d <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c3a:	e8 fe 01 00 00       	call   800e3d <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c8d:	e8 ab 01 00 00       	call   800e3d <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800ce0:	e8 58 01 00 00       	call   800e3d <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d33:	e8 05 01 00 00       	call   800e3d <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d86:	e8 b2 00 00 00       	call   800e3d <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800dfb:	e8 3d 00 00 00       	call   800e3d <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e0b:	83 ec 18             	sub    $0x18,%esp
	int r;

	if (_pgfault_handler == 0) {
  800e0e:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  800e15:	75 1c                	jne    800e33 <set_pgfault_handler+0x2b>
		// First time through!
		// LAB 4: Your code here.
		panic("set_pgfault_handler not implemented");
  800e17:	c7 44 24 08 f4 13 80 	movl   $0x8013f4,0x8(%esp)
  800e1e:	00 
  800e1f:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  800e26:	00 
  800e27:	c7 04 24 18 14 80 00 	movl   $0x801418,(%esp)
  800e2e:	e8 0a 00 00 00       	call   800e3d <_panic>
	}

	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  800e33:	8b 45 08             	mov    0x8(%ebp),%eax
  800e36:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800e3b:	c9                   	leave  
  800e3c:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e40:	56                   	push   %esi
  800e41:	53                   	push   %ebx
  800e42:	83 ec 20             	sub    $0x20,%esp
	va_list ap;

	va_start(ap, fmt);
  800e45:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800e48:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800e4e:	e8 62 fd ff ff       	call   800bb5 <sys_getenvid>
  800e53:	8b 55 0c             	mov    0xc(%ebp),%edx
  800e56:	89 54 24 10          	mov    %edx,0x10(%esp)
  800e5a:	8b 55 08             	mov    0x8(%ebp),%edx
  800e5d:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800e61:	89 74 24 08          	mov    %esi,0x8(%esp)
  800e65:	89 44 24 04          	mov    %eax,0x4(%esp)
  800e69:	c7 04 24 28 14 80 00 	movl   $0x801428,(%esp)
  800e70:	e8 32 f3 ff ff       	call   8001a7 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e75:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800e79:	8b 45 10             	mov    0x10(%ebp),%eax
  800e7c:	89 04 24             	mov    %eax,(%esp)
  800e7f:	e8 c2 f2 ff ff       	call   800146 <vcprintf>
	cprintf("\n");
  800e84:	c7 04 24 5a 11 80 00 	movl   $0x80115a,(%esp)
  800e8b:	e8 17 f3 ff ff       	call   8001a7 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800e90:	cc                   	int3   
  800e91:	eb fd                	jmp    800e90 <_panic+0x53>
  800e93:	66 90                	xchg   %ax,%ax
  800e95:	66 90                	xchg   %ax,%ax
