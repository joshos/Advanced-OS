	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80021f:	e8 cc 0c 00 00       	call   800ef0 <__udivdi3>
  ...
  80027f:	e8 9c 0d 00 00       	call   801020 <__umoddi3>
  800284:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800288:	0f be 80 a6 11 80 00 	movsbl 0x8011a6(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003a3:	ff 24 8d 60 12 80 00 	jmp    *0x801260(,%ecx,4)
  ...
  80046f:	c7 44 24 08 c7 11 80 	movl   $0x8011c7,0x8(%esp)
  800476:	00 
  ...
  8004a1:	b8 b7 11 80 00       	mov    $0x8011b7,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b70:	00 
  800b71:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800b78:	00 
  800b79:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b80:	00 
  800b81:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  800b88:	e8 00 03 00 00       	call   800e8d <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c02:	00 
  800c03:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800c0a:	00 
  800c0b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c12:	00 
  800c13:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  800c1a:	e8 6e 02 00 00       	call   800e8d <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c55:	00 
  800c56:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800c5d:	00 
  800c5e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c65:	00 
  800c66:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  800c6d:	e8 1b 02 00 00       	call   800e8d <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800ca8:	00 
  800ca9:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800cb0:	00 
  800cb1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb8:	00 
  800cb9:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  800cc0:	e8 c8 01 00 00       	call   800e8d <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cfb:	00 
  800cfc:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800d03:	00 
  800d04:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d0b:	00 
  800d0c:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  800d13:	e8 75 01 00 00       	call   800e8d <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d4e:	00 
  800d4f:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800d56:	00 
  800d57:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d5e:	00 
  800d5f:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  800d66:	e8 22 01 00 00       	call   800e8d <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800dc3:	00 
  800dc4:	c7 44 24 08 e8 13 80 	movl   $0x8013e8,0x8(%esp)
  800dcb:	00 
  800dcc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dd3:	00 
  800dd4:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  800ddb:	e8 ad 00 00 00       	call   800e8d <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800df5:	75 68                	jne    800e5f <set_pgfault_handler+0x77>
	{
		// First time through!
  ...
  800e12:	e8 bc fd ff ff       	call   800bd3 <sys_page_alloc>
  800e17:	85 c0                	test   %eax,%eax
  800e19:	79 20                	jns    800e3b <set_pgfault_handler+0x53>
			panic("panic in sys_page_alloc: %e", r);
  800e1b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800e1f:	c7 44 24 08 13 14 80 	movl   $0x801413,0x8(%esp)
  800e26:	00 
  800e27:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e2e:	00 
  800e2f:	c7 04 24 2f 14 80 00 	movl   $0x80142f,(%esp)
  800e36:	e8 52 00 00 00       	call   800e8d <_panic>
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  800e3b:	a1 04 20 80 00       	mov    0x802004,%eax
  800e40:	8b 40 48             	mov    0x48(%eax),%eax
  800e43:	c7 44 24 04 69 0e 80 	movl   $0x800e69,0x4(%esp)
  800e4a:	00 
  800e4b:	89 04 24             	mov    %eax,(%esp)
  800e4e:	e8 cd fe ff ff       	call   800d20 <sys_env_set_pgfault_upcall>
		cprintf("\nUp call set\n");
  800e53:	c7 04 24 3d 14 80 00 	movl   $0x80143d,(%esp)
  800e5a:	e8 32 f3 ff ff       	call   800191 <cprintf>
  ...
  800e62:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800e67:	c9                   	leave  
  800e68:	c3                   	ret    

00800e69 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800e6a:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800e71:	83 c4 04             	add    $0x4,%esp
	...
	//
	// LAB 4: Your code here.
	movl 0x28(%esp),%eax // eax holds the value of trap time eip as we set in the uXtrapframe.
  800e74:	8b 44 24 28          	mov    0x28(%esp),%eax

	movl %esp, %ebp //save the current esp in ebp as we are now going to modify the esp to the traptime esp value.
  800e78:	89 e5                	mov    %esp,%ebp

	movl 0x30(%esp),%esp
  800e7a:	8b 64 24 30          	mov    0x30(%esp),%esp

	pushl %eax   //Push the trap time eip to the traptime stack.
  800e7e:	50                   	push   %eax

	//update the trap time esp value in the trapframe

	movl %esp, 0x30(%ebp)
  800e7f:	89 65 30             	mov    %esp,0x30(%ebp)

	//restore the esp to the exception esp in UXSTACKTOP
  ...
  800e82:	89 ec                	mov    %ebp,%esp
	...
	//the fault va and err does not matter really. Hence we ingnore those registers
	popl %eax //fault_va
  800e84:	58                   	pop    %eax
	popl %eax //err
  800e85:	58                   	pop    %eax

	popal //Restore all the register values. Do not touch the general purpose registers now as they hold their pre trap values.
  800e86:	61                   	popa   
	// LAB 4: Your code here.

	//the next register in the utrapframe is eip, we should not change eip register unless we have finsihed all the processing of the 
	//trapframe. hence add 4 to the esp to skip the eip. The ret instruction will safely change the eip register value.
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e92:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800e95:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800e98:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800e9e:	e8 f2 fc ff ff       	call   800b95 <sys_getenvid>
  800ea3:	8b 55 0c             	mov    0xc(%ebp),%edx
  800ea6:	89 54 24 10          	mov    %edx,0x10(%esp)
  800eaa:	8b 55 08             	mov    0x8(%ebp),%edx
  800ead:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800eb1:	89 74 24 08          	mov    %esi,0x8(%esp)
  800eb5:	89 44 24 04          	mov    %eax,0x4(%esp)
  800eb9:	c7 04 24 4c 14 80 00 	movl   $0x80144c,(%esp)
  800ec0:	e8 cc f2 ff ff       	call   800191 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800ec5:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800ec9:	8b 45 10             	mov    0x10(%ebp),%eax
  800ecc:	89 04 24             	mov    %eax,(%esp)
  800ecf:	e8 5c f2 ff ff       	call   800130 <vcprintf>
	cprintf("\n");
  800ed4:	c7 04 24 49 14 80 00 	movl   $0x801449,(%esp)
  800edb:	e8 b1 f2 ff ff       	call   800191 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800ee0:	cc                   	int3   
  800ee1:	eb fd                	jmp    800ee0 <_panic+0x53>
