...
pgfault(struct UTrapframe *utf)
{
  ...
  8003a1:	c7 44 24 08 2c 17 80 	movl   $0x80172c,0x8(%esp)
  8003a8:	00 
  ...
  80041f:	c7 44 24 04 ff 16 80 	movl   $0x8016ff,0x4(%esp)
  800426:	00 
  800427:	c7 04 24 0d 17 80 00 	movl   $0x80170d,(%esp)
  80042e:	b9 60 20 80 00       	mov    $0x802060,%ecx
  800433:	ba f8 16 80 00       	mov    $0x8016f8,%edx
  ...
  800466:	c7 44 24 08 3c 1a 80 	movl   $0x801a3c,0x8(%esp)
  80046d:	00 
  80046e:	c7 44 24 04 5c 00 00 	movl   $0x5c,0x4(%esp)
  800475:	00 
  800476:	c7 04 24 e7 16 80 00 	movl   $0x8016e7,(%esp)
...
umain(int argc, char **argv)
{
  ...
  80055a:	c7 04 24 60 17 80 00 	movl   $0x801760,(%esp)
  ...
  800570:	c7 44 24 04 14 17 80 	movl   $0x801714,0x4(%esp)
  800577:	00 
  800578:	c7 04 24 25 17 80 00 	movl   $0x801725,(%esp)
  80057f:	b9 20 20 80 00       	mov    $0x802020,%ecx
  800584:	ba f8 16 80 00       	mov    $0x8016f8,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80061d:	c7 04 24 8c 17 80 00 	movl   $0x80178c,(%esp)
  ...
  800633:	e8 51 00 00 00       	call   800689 <vcprintf>
	cprintf("\n");
  800638:	c7 04 24 b0 16 80 00 	movl   $0x8016b0,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80077f:	e8 6c 0c 00 00       	call   8013f0 <__udivdi3>
  ...
  8007df:	e8 3c 0d 00 00       	call   801520 <__umoddi3>
  8007e4:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8007e8:	0f be 80 b0 17 80 00 	movsbl 0x8017b0(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8009af:	c7 44 24 08 c8 17 80 	movl   $0x8017c8,0x8(%esp)
  8009b6:	00 
  ...
  8009cf:	c7 44 24 08 d1 17 80 	movl   $0x8017d1,0x8(%esp)
  8009d6:	00 
  ...
  800a01:	b8 c1 17 80 00       	mov    $0x8017c1,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  8010d0:	00 
  8010d1:	c7 44 24 08 08 1a 80 	movl   $0x801a08,0x8(%esp)
  8010d8:	00 
  8010d9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8010e0:	00 
  8010e1:	c7 04 24 25 1a 80 00 	movl   $0x801a25,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  801162:	00 
  801163:	c7 44 24 08 08 1a 80 	movl   $0x801a08,0x8(%esp)
  80116a:	00 
  80116b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801172:	00 
  801173:	c7 04 24 25 1a 80 00 	movl   $0x801a25,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8011b5:	00 
  8011b6:	c7 44 24 08 08 1a 80 	movl   $0x801a08,0x8(%esp)
  8011bd:	00 
  8011be:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8011c5:	00 
  8011c6:	c7 04 24 25 1a 80 00 	movl   $0x801a25,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  801208:	00 
  801209:	c7 44 24 08 08 1a 80 	movl   $0x801a08,0x8(%esp)
  801210:	00 
  801211:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801218:	00 
  801219:	c7 04 24 25 1a 80 00 	movl   $0x801a25,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80125b:	00 
  80125c:	c7 44 24 08 08 1a 80 	movl   $0x801a08,0x8(%esp)
  801263:	00 
  801264:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80126b:	00 
  80126c:	c7 04 24 25 1a 80 00 	movl   $0x801a25,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8012ae:	00 
  8012af:	c7 44 24 08 08 1a 80 	movl   $0x801a08,0x8(%esp)
  8012b6:	00 
  8012b7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8012be:	00 
  8012bf:	c7 04 24 25 1a 80 00 	movl   $0x801a25,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  801323:	00 
  801324:	c7 44 24 08 08 1a 80 	movl   $0x801a08,0x8(%esp)
  80132b:	00 
  80132c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801333:	00 
  801334:	c7 04 24 25 1a 80 00 	movl   $0x801a25,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801355:	75 68                	jne    8013bf <set_pgfault_handler+0x77>
	{
		// First time through!
  ...
  801379:	79 20                	jns    80139b <set_pgfault_handler+0x53>
			panic("panic in sys_page_alloc: %e", r);
  80137b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80137f:	c7 44 24 08 33 1a 80 	movl   $0x801a33,0x8(%esp)
  801386:	00 
  801387:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80138e:	00 
  80138f:	c7 04 24 4f 1a 80 00 	movl   $0x801a4f,(%esp)
  801396:	e8 56 f2 ff ff       	call   8005f1 <_panic>
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  80139b:	a1 cc 20 80 00       	mov    0x8020cc,%eax
  8013a0:	8b 40 48             	mov    0x48(%eax),%eax
  8013a3:	c7 44 24 04 c9 13 80 	movl   $0x8013c9,0x4(%esp)
  8013aa:	00 
  8013ab:	89 04 24             	mov    %eax,(%esp)
  8013ae:	e8 cd fe ff ff       	call   801280 <sys_env_set_pgfault_upcall>
		cprintf("\nUp call set\n");
  8013b3:	c7 04 24 5d 1a 80 00 	movl   $0x801a5d,(%esp)
  8013ba:	e8 2b f3 ff ff       	call   8006ea <cprintf>
  ...
  8013c2:	a3 d0 20 80 00       	mov    %eax,0x8020d0
}
  8013c7:	c9                   	leave  
  8013c8:	c3                   	ret    

008013c9 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  8013ca:	a1 d0 20 80 00       	mov    0x8020d0,%eax
	call *%eax
  ...
  8013de:	50                   	push   %eax
	...
	movl %esp, 0x30(%ebp)
  8013df:	89 65 30             	mov    %esp,0x30(%ebp)
