	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002df:	e8 6c 0c 00 00       	call   800f50 <__udivdi3>
  ...
  80033f:	e8 3c 0d 00 00       	call   801080 <__umoddi3>
  800344:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800348:	0f be 80 7c 12 80 00 	movsbl 0x80127c(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80050f:	c7 44 24 08 94 12 80 	movl   $0x801294,0x8(%esp)
  800516:	00 
  ...
  80052f:	c7 44 24 08 9d 12 80 	movl   $0x80129d,0x8(%esp)
  800536:	00 
  ...
  800561:	b8 8d 12 80 00       	mov    $0x80128d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c30:	00 
  800c31:	c7 44 24 08 c8 14 80 	movl   $0x8014c8,0x8(%esp)
  800c38:	00 
  800c39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c40:	00 
  800c41:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cc2:	00 
  800cc3:	c7 44 24 08 c8 14 80 	movl   $0x8014c8,0x8(%esp)
  800cca:	00 
  800ccb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd2:	00 
  800cd3:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d15:	00 
  800d16:	c7 44 24 08 c8 14 80 	movl   $0x8014c8,0x8(%esp)
  800d1d:	00 
  800d1e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d25:	00 
  800d26:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d68:	00 
  800d69:	c7 44 24 08 c8 14 80 	movl   $0x8014c8,0x8(%esp)
  800d70:	00 
  800d71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d78:	00 
  800d79:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dbb:	00 
  800dbc:	c7 44 24 08 c8 14 80 	movl   $0x8014c8,0x8(%esp)
  800dc3:	00 
  800dc4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dcb:	00 
  800dcc:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e0e:	00 
  800e0f:	c7 44 24 08 c8 14 80 	movl   $0x8014c8,0x8(%esp)
  800e16:	00 
  800e17:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e1e:	00 
  800e1f:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e83:	00 
  800e84:	c7 44 24 08 c8 14 80 	movl   $0x8014c8,0x8(%esp)
  800e8b:	00 
  800e8c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e93:	00 
  800e94:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800eb5:	75 68                	jne    800f1f <set_pgfault_handler+0x77>
	{
		// First time through!
		// LAB 4: Your code here.
		int r;
		if((r = sys_page_alloc(thisenv->env_id, (void *)(UXSTACKTOP-PGSIZE), PTE_P | PTE_U | PTE_W)) < 0)
  800eb7:	a1 04 20 80 00       	mov    0x802004,%eax
  ...
  800ed9:	79 20                	jns    800efb <set_pgfault_handler+0x53>
			panic("panic in sys_page_alloc: %e", r);
  800edb:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800edf:	c7 44 24 08 f3 14 80 	movl   $0x8014f3,0x8(%esp)
  800ee6:	00 
  800ee7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800eee:	00 
  800eef:	c7 04 24 0f 15 80 00 	movl   $0x80150f,(%esp)
  800ef6:	e8 55 f2 ff ff       	call   800150 <_panic>
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  800efb:	a1 04 20 80 00       	mov    0x802004,%eax
  800f00:	8b 40 48             	mov    0x48(%eax),%eax
  800f03:	c7 44 24 04 29 0f 80 	movl   $0x800f29,0x4(%esp)
  800f0a:	00 
  800f0b:	89 04 24             	mov    %eax,(%esp)
  800f0e:	e8 cd fe ff ff       	call   800de0 <sys_env_set_pgfault_upcall>
		cprintf("\nUp call set\n");
  800f13:	c7 04 24 1d 15 80 00 	movl   $0x80151d,(%esp)
  800f1a:	e8 2a f3 ff ff       	call   800249 <cprintf>
  ...
  800f22:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800f27:	c9                   	leave  
  800f28:	c3                   	ret    

00800f29 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800f2a:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800f3e:	50                   	push   %eax
	...
	movl %esp, 0x30(%ebp)
  800f3f:	89 65 30             	mov    %esp,0x30(%ebp)
