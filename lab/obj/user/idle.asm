...
umain(int argc, char **argv)
{
  ...
  800040:	10 80 00 
	...
	while (1) {
		sys_yield();
  800043:	e8 3c 0b 00 00       	call   800b84 <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  800059:	e8 07 0b 00 00       	call   800b65 <sys_getenvid>
	int index = envid & (1023);
  80005e:	25 ff 03 00 00       	and    $0x3ff,%eax
  800063:	89 c6                	mov    %eax,%esi
	cprintf("Value of x:%x\n",index);
  800065:	89 44 24 04          	mov    %eax,0x4(%esp)
  800069:	c7 04 24 a5 10 80 00 	movl   $0x8010a5,(%esp)
  800070:	e8 ea 00 00 00       	call   80015f <cprintf>
	thisenv = &envs[index];
  800075:	6b f6 7c             	imul   $0x7c,%esi,%esi
  800078:	81 c6 00 00 c0 ee    	add    $0xeec00000,%esi
  80007e:	89 35 04 20 80 00    	mov    %esi,0x802004
	// save the name of the program so that panic() can use it
	if (argc > 0)
  800084:	85 db                	test   %ebx,%ebx
  800086:	7e 07                	jle    80008f <libmain+0x45>
		binaryname = argv[0];
  800088:	8b 07                	mov    (%edi),%eax
...
exit(void)
{
  ...
  8000b5:	e8 59 0a 00 00       	call   800b13 <sys_env_destroy>
}
  8000ba:	c9                   	leave  
  8000bb:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000e9:	e8 e8 09 00 00       	call   800ad6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80013a:	e8 af 01 00 00       	call   8002ee <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800152:	e8 7f 09 00 00       	call   800ad6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 be 10 80 00 	movsbl 0x8010be(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80041f:	c7 44 24 08 d6 10 80 	movl   $0x8010d6,0x8(%esp)
  800426:	00 
  ...
  80043f:	c7 44 24 08 df 10 80 	movl   $0x8010df,0x8(%esp)
  800446:	00 
  ...
  800471:	b8 cf 10 80 00       	mov    $0x8010cf,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b40:	00 
  800b41:	c7 44 24 08 08 13 80 	movl   $0x801308,0x8(%esp)
  800b48:	00 
  800b49:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b50:	00 
  800b51:	c7 04 24 25 13 80 00 	movl   $0x801325,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bd2:	00 
  800bd3:	c7 44 24 08 08 13 80 	movl   $0x801308,0x8(%esp)
  800bda:	00 
  800bdb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800be2:	00 
  800be3:	c7 04 24 25 13 80 00 	movl   $0x801325,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c25:	00 
  800c26:	c7 44 24 08 08 13 80 	movl   $0x801308,0x8(%esp)
  800c2d:	00 
  800c2e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c35:	00 
  800c36:	c7 04 24 25 13 80 00 	movl   $0x801325,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c78:	00 
  800c79:	c7 44 24 08 08 13 80 	movl   $0x801308,0x8(%esp)
  800c80:	00 
  800c81:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c88:	00 
  800c89:	c7 04 24 25 13 80 00 	movl   $0x801325,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ccb:	00 
  800ccc:	c7 44 24 08 08 13 80 	movl   $0x801308,0x8(%esp)
  800cd3:	00 
  800cd4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cdb:	00 
  800cdc:	c7 04 24 25 13 80 00 	movl   $0x801325,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d1e:	00 
  800d1f:	c7 44 24 08 08 13 80 	movl   $0x801308,0x8(%esp)
  800d26:	00 
  800d27:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d2e:	00 
  800d2f:	c7 04 24 25 13 80 00 	movl   $0x801325,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800d93:	00 
  800d94:	c7 44 24 08 08 13 80 	movl   $0x801308,0x8(%esp)
  800d9b:	00 
  800d9c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800da3:	00 
  800da4:	c7 04 24 25 13 80 00 	movl   $0x801325,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800de4:	c7 04 24 34 13 80 00 	movl   $0x801334,(%esp)
  800deb:	e8 6f f3 ff ff       	call   80015f <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800df0:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800df4:	8b 45 10             	mov    0x10(%ebp),%eax
  800df7:	89 04 24             	mov    %eax,(%esp)
  800dfa:	e8 ff f2 ff ff       	call   8000fe <vcprintf>
	cprintf("\n");
  800dff:	c7 04 24 b2 10 80 00 	movl   $0x8010b2,(%esp)
  800e06:	e8 54 f3 ff ff       	call   80015f <cprintf>
