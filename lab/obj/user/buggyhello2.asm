...
umain(int argc, char **argv)
{
  ...
  800049:	e8 61 00 00 00       	call   8000af <sys_cputs>
}
  80004e:	c9                   	leave  
  80004f:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  80005e:	e8 db 00 00 00       	call   80013e <sys_getenvid>
...
sys_env_destroy(envid_t envid)
{
  ...
  800119:	00 
  80011a:	c7 44 24 08 78 0e 80 	movl   $0x800e78,0x8(%esp)
  800121:	00 
  800122:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800129:	00 
  80012a:	c7 04 24 95 0e 80 00 	movl   $0x800e95,(%esp)
  800131:	e8 27 00 00 00       	call   80015d <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800168:	8b 35 04 20 80 00    	mov    0x802004,%esi
  80016e:	e8 cb ff ff ff       	call   80013e <sys_getenvid>
  ...
  800189:	c7 04 24 a4 0e 80 00 	movl   $0x800ea4,(%esp)
  ...
  80019f:	e8 51 00 00 00       	call   8001f5 <vcprintf>
	cprintf("\n");
  8001a4:	c7 04 24 6c 0e 80 00 	movl   $0x800e6c,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8001e0:	e8 ca fe ff ff       	call   8000af <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800249:	e8 61 fe ff ff       	call   8000af <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800348:	0f be 80 c8 0e 80 00 	movsbl 0x800ec8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80050f:	c7 44 24 08 e0 0e 80 	movl   $0x800ee0,0x8(%esp)
  800516:	00 
  ...
  80052f:	c7 44 24 08 e9 0e 80 	movl   $0x800ee9,0x8(%esp)
  800536:	00 
  ...
  800561:	b8 d9 0e 80 00       	mov    $0x800ed9,%eax
