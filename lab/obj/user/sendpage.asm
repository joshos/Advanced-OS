...
umain(int argc, char **argv)
{
  ...
  80007a:	e8 76 02 00 00       	call   8002f5 <cprintf>
  ...
  8000b0:	e8 40 02 00 00       	call   8002f5 <cprintf>
  ...
  8001a3:	e8 4d 01 00 00       	call   8002f5 <cprintf>
  ...
  8001d9:	e8 17 01 00 00       	call   8002f5 <cprintf>
	return;
}
  8001de:	c9                   	leave  
  8001df:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  8001ec:	8b 7d 0c             	mov    0xc(%ebp),%edi
  ...
  8001ef:	e8 01 0b 00 00       	call   800cf5 <sys_getenvid>
  ...
  8001ff:	c7 04 24 a2 13 80 00 	movl   $0x8013a2,(%esp)
  800206:	e8 ea 00 00 00       	call   8002f5 <cprintf>
	thisenv = &envs[index];
  80020b:	6b f6 7c             	imul   $0x7c,%esi,%esi
  80020e:	81 c6 00 00 c0 ee    	add    $0xeec00000,%esi
  800214:	89 35 0c 20 80 00    	mov    %esi,0x80200c
	// save the name of the program so that panic() can use it
	if (argc > 0)
  80021a:	85 db                	test   %ebx,%ebx
  80021c:	7e 07                	jle    800225 <libmain+0x45>
		binaryname = argv[0];
  80021e:	8b 07                	mov    (%edi),%eax
  800220:	a3 08 20 80 00       	mov    %eax,0x802008
  ...
  80022c:	e8 02 fe ff ff       	call   800033 <umain>
	...
	// exit gracefully
	exit();
  800231:	e8 08 00 00 00       	call   80023e <exit>
}
  800236:	83 c4 1c             	add    $0x1c,%esp
  800239:	5b                   	pop    %ebx
  80023a:	5e                   	pop    %esi
  80023b:	5f                   	pop    %edi
  80023c:	5d                   	pop    %ebp
...
exit(void)
{
  ...
  800241:	83 ec 18             	sub    $0x18,%esp
	sys_env_destroy(0);
  800244:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80024b:	e8 53 0a 00 00       	call   800ca3 <sys_env_destroy>
}
  800250:	c9                   	leave  
  800251:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  80027f:	e8 e2 09 00 00       	call   800c66 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8002d0:	e8 a9 01 00 00       	call   80047e <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  8002e8:	e8 79 09 00 00       	call   800c66 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8003e8:	0f be 80 bb 13 80 00 	movsbl 0x8013bb(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8005af:	c7 44 24 08 d3 13 80 	movl   $0x8013d3,0x8(%esp)
  8005b6:	00 
  ...
  8005cf:	c7 44 24 08 dc 13 80 	movl   $0x8013dc,0x8(%esp)
  8005d6:	00 
  ...
  800601:	b8 cc 13 80 00       	mov    $0x8013cc,%eax
